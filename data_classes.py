...
# # Description: A collection of classes for storing data
# ChangeLog: (Who, When, What)
# LBatista, 12.1.2023, created script
# LBatista, 12.8.2023, updated to allow for hyphens in names
# ------------------------------------------------------------------------------------------------- #
...
class Person:
    ...
    - LBatista, 12.1.2023: Added class to data_classes file
    """

    def __init__(self, first_name: str = "", last_name: str = ""):  # Empty string is a default value (optional)
    ...
    def first_name(self, value: str):
        if all((char.isalpha() or char == '-') for char in value) or value == "":  # Adjustment of code to allow hyphen
